...
For this part of the module. You'll be working with the "Arizona" dataset from the SpatialR package. 

Using one line of code you can load shapefiles into R and read them. Note: The “.” is the source and "Arizona" is the layer. 
...
###Example 
For this example, you'll be using the "Peru" dataset. 
...
This tutorial used the "Austin" data in the SpatialR package. 
