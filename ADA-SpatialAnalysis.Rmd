...
##Preliminaries
Load and install the following packages: {tmap}, {leaflet}, {rgdal}, {rgeos}, {sp}, {raster}, {adehabitatHR}, {sf}, {devtools}, {rayshader}
...
# Setting the projection to the appropriate coordinate system
...
#Now that we have our raster cropped, we need convert it to a matrix:
